      ...
      <div class="relative wrap overflow-hidden p-10 h-full">
        ...
        <div class="mb-8 flex justify-between items-center w-full right-timeline">
          ...
          <div class="order-1 bg-slate-200 rounded-lg shadow-xl lg:w-5/12 px-6 py-4">
            ...
            <p class="text-sm font-medium leading-snug tracking-wide text-slate-700 text-opacity-100">
        ...
        <div class="mb-8 flex justify-between lg:flex-row-reverse items-center w-full left-timeline">
          <div class="order-1 lg:w-5/12"></div>
          <div class="z-20 flex items-center order-1 bg-slate-200 shadow-xl lg:mr-0 mr-8 lg:p-3 lg:w-28 lg:h-8 rounded-full p-3 ">
            <h1 class="mx-auto font-semibold text-lg text-slate-700">2021/2024</h1>
          </div>
          <div class="order-1 bg-slate-200 rounded-lg shadow-xl lg:w-5/12 px-6 py-4">
            <h3 class="mb-3 font-bold text-slate-700 text-xl">
