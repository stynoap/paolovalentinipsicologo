    ...
    <div class="container mx-auto w-full h-full">
      <div class="relative wrap overflow-hidden p-10 h-full">
        ...
        <div class="mb-8 flex justify-between lg:flex-row-reverse items-center w-full left-timeline mt-16">
          ...
          <div class="z-20 lg:flex items-center order-1 bg-slate-200 shadow-xl lg:mr-0 mr-8 lg:p-0 p-3 lg:w-14 lg:h-8 rounded-full hidden">
            <h1 class="mx-auto font-semibold text-lg text-slate-700">2023</h1>
          </div>
          <div class="order-1 bg-slate-200 rounded-lg shadow-xl lg:w-5/12 px-6 py-4 sm:w-full">
          <h1 class="mx-auto font-semibold text-sm text-slate-500 sm:block rounded-sm lg:hidden">2023</h1>
        ...
        <div class="mb-8 flex justify-between lg:flex-row-reverse items-center w-full left-timeline">
          <div class="order-1 lg:w-5/12"></div>
          <div class="z-20 lg:flex items-center order-1 bg-slate-200 shadow-xl lg:mr-0 mr-8 lg:p-0 p-3 lg:w-14 lg:h-8 rounded-full hidden">
            <h1 class="mx-auto font-semibold text-sm text-slate-700">2021</h1>
          </div>
          <div class="order-1 bg-slate-200 rounded-lg shadow-xl lg:w-5/12 px-6 py-4 sm:w-full">
          <h1 class="mx-auto font-semibold text-sm text-slate-500 sm:block rounded-sm lg:hidden">2021</h1>
            <h3 class="mb-3 font-bold text-slate-700 lg:text-xl">
            Educatore domiciliare livello D1 e Assistente all' educativa scolastica
            </h3>
            <p class="text-sm leading-snug tracking-wide text-gray-900 text-opacity-200">
            Cooperativa COOSS  Marche Onlus
              <br />
              <br />
              <b>fino al 2024</b>
            </p>
        ...
        <div class="mb-8 flex justify-between lg:flex-row-reverse items-center w-full left-timeline">
          <div class="order-1 lg:w-5/12"></div>
          <div class="z-20 lg:flex items-center order-1 bg-slate-200 shadow-xl lg:mr-0 mr-8 lg:p-0 p-3 lg:w-14 lg:h-8 rounded-full invisible hidden">
            <h1 class="mx-auto font-semibold text-lg text-slate-700">2020</h1>
          </div>
          <div class="order-1 bg-slate-200 rounded-lg shadow-xl lg:w-5/12 px-6 py-4 sm:w-full">
          <h1 class="mx-auto font-semibold text-sm text-slate-500  sm:block rounded-sm lg:hidden">2020</h1>
            <h3 class="mb-3 font-bold text-slate-700 lg:text-xl">
        ...
        <div class="mb-8 flex justify-between items-center w-full right-timeline">
          ...
          <h1 class="mx-auto font-semibold text-sm text-slate-500 sm:block rounded-sm lg:hidden">2020</h1>
            ...
            <p class="text-sm font-medium leading-snug tracking-wide text-slate-700 text-opacity-200">
              Servizi per l'immigrazione <b>siproimi</b> Porto San giorgio (FM)
            </p>
          </div>
        </div>
        {/* <!-- left timeline --> */}
        <div class="mb-8 flex justify-between lg:flex-row-reverse items-center w-full left-timeline">
          ...
          <h1 class="mx-auto font-semibold text-sm text-slate-500 sm:block rounded-sm lg:hidden">2020</h1>
            ...
            <p class="text-sm leading-snug tracking-wide text-gray-900 text-opacity-200">
              ...
              <ul className="list-disc text-sm font-bold flex flex-col gap-3 mt-2">
                <li>
                  Partecipazione a seminari per tecniche di intervento
                  specifiche nelle psicoterapie
                </li>
                <li>
                  Approfondimento del tema della psicotraumatologia e dello
                  studio dello stress traumatico
                </li>
                <li>
                  Approfondimenti di ricerca in psicoterapia delle psicosi{" "}
                </li>
              </ul>        
            </p>
        ...
        <div class="mb-8 flex justify-between items-center w-full right-timeline">
          ...
          <div class="order-1 bg-slate-200 rounded-lg shadow-xl lg:w-5/12 px-6 py-4 sm:w-full">
          <h1 class="mx-auto font-semibold text-sm text-slate-500 sm:block rounded-sm lg:hidden">2019</h1>
            <h3 class="mb-3 font-bold text-slate-700 lg:text-xl">
        ...
        <div class="mb-8 flex justify-between lg:flex-row-reverse items-center w-full left-timeline">
          ...
          <div class="order-1 bg-slate-200 rounded-lg shadow-xl lg:w-5/12 px-6 py-4 sm:w-full">
          <h1 class="mx-auto text-sm font-semibold text-slate-500 sm:block rounded-sm lg:hidden">2014</h1>
            <h3 class="mb-3 font-bold text-slate-700 lg:text-xl">
